...
from Modules.utilities import ohlc_chart, decompose_series, plot_dataframe, transform_dataset, dataset_division
...
# todo so far indicators are not considered. use describe
...
# DATA INFERENCE =======================================================================================================
prophet_predictions(train, valid, validation=True, regressor=True)
# todo ingloba test e valid
# prophet_predictions(train, test, validation=False)
